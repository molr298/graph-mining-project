...
if __name__ == '__main__':
   ...
   if RUN :
     ...
     if OPTIONS == "INSERT":
        st.session_state.check.Insert_Connect(op_sd)
        #st.session_state.check = G
     if OPTIONS == "DELETE":
        st.session_state.check.Delete_Connect(op_sd)
       
     visualization(st.session_state.check)
